# -*- coding: utf-8 -*-
"""
GRU baseline for the sentiment analysis project.

Reads data from ../processed_data and writes one metrics figure per experiment to:
    other/final-GRU/<hyperparameter-run-name>/metrics.png
"""
...
CONFIG: Dict[str, Any] = {
    ...
    "output_root": os.path.join("other", "final-GRU"),
    "run_name_keys": [
        "lr",
        "batch_size",
        "hidden_dim",
...
def run_one_experiment(cfg: Dict[str, Any], data_info: Dict[str, Any], base_dir: str) -> Dict[str, float]:
    ...
    plot_metrics(history, test_metrics, metrics_path, f"GRU - {run_name}")
    print(
